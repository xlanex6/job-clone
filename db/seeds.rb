...
# Jobs
Job.create(title:"Chef du monde", content:"domine le monde", start_time:Time.now, end_time:Time.now, address:"3 rue blabla", skill_id:1, user_id:4)
Job.create(title:"Chef de la terre", content:"domine la terre", start_time:Time.now, end_time:Time.now, address:"3 rue blabla", skill_id:2, user_id:4)
Job.create(title:"Patron", content:"domine la sieste", start_time:Time.now, end_time:Time.now, address:"5 rue blabla", skill_id:3, user_id:4)
Job.create(title:"CTO", content:"domine les serveurs", start_time:Time.now, end_time:Time.now, address:"7 rue blabla", skill_id:2, user_id:5)
Job.create(title:"Nerd en chef", content:"Dodo dans la matrice", start_time:Time.now, end_time:Time.now, address:"9 rue blabla", skill_id:4, user_id:4)
Job.create(title:"Assistant d'assistant", content:"se fait dominer", start_time:Time.now, end_time:Time.now, address:"2 rue blabla", skill_id:5, user_id:5)
Job.create(title:"Secrétaire", content:"promotion canapé", start_time:Time.now, end_time:Time.now, address:"10 rue blabla", skill_id:2, user_id:5)
Job.create(title:"Stagiaire à vie", content:"pas de salaire", start_time:Time.now, end_time:Time.now, address:"43 rue blabla", skill_id:2, user_id:4)
Job.create(title:"Gestionnaire de barraque à frites", content:"vente de frites toute la journée", start_time:Time.now, end_time:Time.now, address:"22 rue blabla", skill_id:5, user_id:4)
Job.create(title:"Assistant de direction assistée", content:"Poste pour fan d'automobile", start_time:Time.now, end_time:Time.now, address:"120 rue blabla", skill_id:2, user_id:5)
Job.create(title:"Chef du rien", content:"Vous ne ferez rien de la journée", start_time:Time.now, end_time:Time.now, address:"0 rue blabla", skill_id:3, user_id:4)
Job.create(title:"Livreur de pizza", content:"Vous deviendrez pilote d'élite", start_time:Time.now, end_time:Time.now, address:"1000 rue blabla", skill_id:4, user_id:5)
